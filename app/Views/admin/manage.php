                  ...
                  <header class="page-cover">
                    <div class="text-center">
                      ...
                      <div style="margin-bottom: 5px">
                        ...
                        <span class="text-black">
                          <?= $currency . number_format($check_balance ?? 0, 2); ?>/
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <h5 class="text-black">
                      <?= $currency; ?>
                      <?= number_format($check_balance ?? 0, 2); ?>
                    </h5>
                  ...
                  <div class="col-lg-3">
                    <span class="text-black font-weight-bold">
                      <?= $currency; ?>
                      <?= number_format($cMonthlyCredit ?? 0, 2); ?>
                    </span><br>
                  ...
                  <div class="col-lg-3">
                    <span class="text-black font-weight-bold">
                      <?= $currency; ?>
                      <?= number_format($cMonthlyDebit ?? 0, 2); ?>
                    </span><br>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <span class="text-black font-weight-bold">
                      <?= $currency; ?>
                      <?= number_format($MonthlyDebit ?? 0, 2); ?>
                    </span><br>
                    <small class="text-muted font-weight-bold">Debit this month</small>
                  </div>
                </div>
